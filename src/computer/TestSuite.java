...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessfully() throws InterruptedException {
      ...
      //2.21 Click on “CHECKOUT AS GUEST” Tab
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"), "viral");//firstname
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"), "Devani");//lastname
        sendTextToElement(By.id("BillingNewAddress_Email"),"viral123@gmail.com");//email
        ...
        sendTextToElement(By.cssSelector("#BillingNewAddress_ZipPostalCode"), "SW1A2A");//Zip/Postal code
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"), "07598950493");//Phone number
